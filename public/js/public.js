...
socket.on('status-current',(payload)=>{
    ...
    if(ticket1){
        lblTicket1.innerText = 'Turno '+ticket1.number;
        lblDesktop1.innerText = ticket1.desktop;
    }    
    if(ticket2){
        lblTicket2.innerText = 'Turno '+ticket2.number;
        lblDesktop2.innerText = ticket2.desktop;
    }
    if(ticket3){
        lblTicket3.innerText = 'Turno '+ticket3.number;
        lblDesktop3.innerText = ticket3.desktop;
    }
    if(ticket4){
        lblTicket4.innerText = 'Turno '+ticket4.number;
